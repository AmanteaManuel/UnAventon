...
<body runat="server">
    ...
    <hr />
        <h4 class="text-center Text-Shadow"  style="color:white" > Por favor, ingresé los datos solicitados a continuación para poder usar la página o puede 
            <a style="color:orangered" href="#" id="#">
                                ...
                                <div id="login-form" role="form" style="display: block;">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-sm-offset-3">
                                                <asp:Button Text="Registrar" runat="server" class="form-control btn btn-login" tabindex="4" ID="btnRegistrar" OnClick="btnRegistrar_Click"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
