<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecuperarCuenta1.aspx.cs" Inherits="UnAventon.Usuario.RecuperarCuenta1" %>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3" >	           
                ...
                <div class="form-group help-block" > 
		            ...
		            <asp:TextBox runat="server" ID="TextBox1" type="password" PlaceHolder="Ejemplo: abc123"  CssClass ="form-control" width="200"/>
                ...
                <div class="form-group help-block" >                        
                    <asp:Button Text="Recuperar" Visible="true" type="password" runat="server" ID="btnRegistrarse" CssClass="boton_personalizado"  />
	            </div> 
